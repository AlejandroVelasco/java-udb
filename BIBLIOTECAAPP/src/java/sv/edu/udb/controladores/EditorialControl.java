...
import sv.edu.udb.modelo.EditorialDao;
...
public class EditorialControl extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        editorial.setUrl(url);

        if (EditorialDao.guardarEditorial(editorial)) {
            //SE INSERTO CORRECTAMENTE
            request.setAttribute("mensaje", "Editorial guardada correctamente");
        } else {
            //DIO UN INCONVENIENTE        
            request.setAttribute("mensaje", "Editorial no guardada");
        }
        request.getRequestDispatcher("/Catalogos/Editoriales/agregar.jsp").forward(request, response);
    }
